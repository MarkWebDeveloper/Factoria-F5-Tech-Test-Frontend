...
async function handleSubmit(): Promise<void> {
    ...
    if (imagesStore.updatingImageFile != null) {
        formData.append('file', imagesStore.updatingImageFile)
    }
...
<template>
    <div class="form-background">
        <form class="form-container" @submit.prevent="handleSubmit">
            <button class="close-button" @click="imagesStore.switchUpdateForm()">
            ...
            <label for="image-upload" class="image-input-label">
                <div class="image-background">
                    <div class="image"
                        :style="{ 'background-image': 'url(' + imagesStore.updatingImageUrl + ')' }" alt="image"></div>
                    </div>
                <input @change="imagesStore.handleFileUpdate" class="image-input" type="file" name="file"
                    id="image-upload">
            </label>
            <input class="email-input" type="text" name="email-input" id="email-input" v-model="imagesStore.updatingImageTitle" required placeholder="Insert Image Title">
